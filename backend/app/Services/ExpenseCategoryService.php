...
class ExpenseCategoryService extends MasterDataService
{
    ...
    public function storeRules(?int $companyId = null): array
    {
        return [
            ...
            'code' => [
                ...
                Rule::unique('expense_categories')->where(fn ($q) => $q->where('company_id', $companyId)),
            ],
    ...
    public function updateRules(int $id, ?int $companyId = null): array
    {
        return [
            ...
            'code' => [
                ...
                Rule::unique('expense_categories')->where(fn ($q) => $q->where('company_id', $companyId))->ignore($id),
            ],
            'description' => ['nullable', 'string'],
            'is_active' => ['sometimes', 'boolean'],
            'sort_order' => ['sometimes', 'integer', 'min:0'],
