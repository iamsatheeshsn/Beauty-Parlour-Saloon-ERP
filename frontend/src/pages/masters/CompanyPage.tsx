...
export default function CompanyPage() {
  ...
  const [countriesQuery, emiratesQuery, citiesQuery] = useQueries({
    queries: [
      { queryKey: ['countries-options'], queryFn: () => countryService.list({ all: true }) },
      {
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb items={[{ label: 'Masters', href: '/masters/branches' }, { label: 'Company' }]} />
